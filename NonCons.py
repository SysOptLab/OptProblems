    ...
    def __init__(self, name):
        ...
        if name == 'Ackley Function':
            ...
            def obj(x):
                x1 = x[0]
                x2 = x[1]
                term1 = 100.0 * math.sqrt(math.abs(x2 - 0.01*x1**2))
                term2 = 0.01 * math.abs(x1 + 10.0)
                f = term1 + term2
                return f
            ...
            def obj(x):
                ...
                fact2 = math.exp(math.abs(100.0 - math.sqrt(x1**2+x2**2)/math.pi))
                f = - 0.0001 * (math.abs(fact1*fact2)+1.0)^0.1
                return f
            ...
            def obj(x):
                x1 = x[0]
                x2 = x[1]
                term1 = -(x2+47.0) * math.sin(math.sqrt(math.abs(x2+x1/2.0+47.0)))
                term2 = -x1 * math.sin(math.sqrt(math.abs(x1-(x2+47.0))))
                y = term1 + term2
                return f
            ...
            def obj(x):
                ...
                fact2 = math.exp(math.abs(1.0 - math.sqrt(x1**2+x2**2)/math.pi))
                f = - math.abs(fact1*fact2)
                return f
